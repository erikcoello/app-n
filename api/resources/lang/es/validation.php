    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'unique' => 'El nombre ya se encuentra en uso'
        ],
        'category_id' => [
            'required' => 'Debes seleccionar una categoria'
        ],
        'documents' => [
            'required' => 'Es necesario seleccionar al menos un archivo archivo'
        ],
        'document' => [
            'required' => 'Es necesario seleccionar un archivo',
            'mimes' => 'Solo se aceptan extensiones: pdf,doc,docx,xls,xlsx,ppt,pptx'
        ],
        'date_start' => [
        ...
        'date_end' => [
            'required' => 'La fecha y hora de termino es obligatoria',
            'date' => 'La fecha no es valida'
        ],
        'password_now' => [
            'required' => 'El campo es obligatorio',
